    ...
    <div class="container">
      <nav class="socials-menu">
        <ul>
          ...
          <li>
            <a target="_blank" href="tel:+380663280061"><font-awesome-icon :icon="['fas', 'phone-square-alt']"/></a>
          </li>
          <li class="link-phone">
      ...
      <p>© 2021, Всі права захищені. Sweet Bakery. </p>
      <!-- <p><a href="mailto:sweet.bakery@gmail.com">sweet.bakery@gmail.com</a></p> -->
    </div>
  </footer>
</template>
<style>
